...
public abstract class PendingItemAnimator<H extends ViewHolder> extends RecyclerView.ItemAnimator {
    ...
    private final void runAddAnimation(boolean removalsPending, boolean movesPending,
    ...
    protected boolean prepHolderForAnimateMove(final H holder, int fromX, int fromY, int toX,
            int toY) {
    ...
    /**
     * Preform your animation. You do not need to override this in most cases
     * cause the default is pretty good. Listeners will be overridden
     **/
    protected ViewPropertyAnimatorCompat animateMoveImpl(final ViewHolder holder, int fromX,
    ...
    public boolean isRunning() {
        return (!mMoveAnimations.isEmpty() || !mRemoveAnimations.isEmpty()
                || !mAddAnimations.isEmpty() || !mMoves.isEmpty() || !mAdditions.isEmpty());
    }
    ...
    /**
     * This class is just convince so that you don't have to override things you
     * don't want to.
     **/
